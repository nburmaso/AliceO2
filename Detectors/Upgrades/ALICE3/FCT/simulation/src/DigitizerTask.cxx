...
#include "FCTSimulation/DigitizerTask.h"
...
DigitizerTask::DigitizerTask() : FairTask("FCTDigitizerTask"), mDigitizer() {}
//_____________________________________________________________________________
...
InitStatus DigitizerTask::Init()
{
  ...
  mHitsArray = mgr->InitObjectAs<const std::vector<o2::itsmft::Hit>*>("FCTHit");
  if (!mHitsArray) {
    LOG(error) << "FCT hits not registered in the FairRootManager. Exiting ...";
    return kERROR;
  }

  // Register output container
  mgr->RegisterAny("FCTDigit", mDigitsArrayPtr, kTRUE);
  mgr->RegisterAny("FCTDigitMCTruth", mMCTruthArrayPtr, kTRUE);
