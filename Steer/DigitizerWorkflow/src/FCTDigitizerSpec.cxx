...
class FCTDPLDigitizerTask : BaseDPLDigitizer
{
 public:
  FCTDPLDigitizerTask(bool mctruth = true)
    : BaseDPLDigitizer(InitServices::FIELD | InitServices::GEOM), mWithMCTruth(mctruth) {}
  ...
  void run(framework::ProcessingContext& pc)
  {
    ...
    // todo: switch to FCT somehow???
    updateTimeDependentParams<o2::detectors::DetID::MFT>(pc);
    ...
    TStopwatch timer;
    timer.Start();
    LOG(info) << " CALLING FCT DIGITIZATION ";
  ...
  {
    // todo: no noise and active map at the moment
 ...
 protected:
  ...
  void updateTimeDependentParams(ProcessingContext& pc)
  {
    ...
    auto& dopt = o2::fct::DPLDigitizerParam::Instance();
    auto& aopt = o2::fct::DPLAlpideParam::Instance();
  ...
  o2::detectors::DetID mID{o2::detectors::DetID::FCT};
  o2::header::DataOrigin mOrigin = o2::header::gDataOriginFCT;
  o2::fct::Digitizer mDigitizer;
...
DataProcessorSpec getFCTDigitizerSpec(int channel, bool mctruth)
{
  std::string detStr = o2::detectors::DetID::getName(o2::detectors::DetID::FCT);
  auto detOrig = o2::header::gDataOriginFCT;
  ...
  return DataProcessorSpec{detStr + "Digitizer",
                           ...
                           AlgorithmSpec{adaptFromTask<FCTDPLDigitizerTask>(mctruth)},
